...
const Home = () => {
    ...
    const heroStats = [
        ...
        { number: '30+', label: 'Faculty' }
    ];

    return (
        <div className="min-h-screen min-w-screen bg-white pt-16">
            <NaavBar />
            {/* Hero Section */}
            <div className="container mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button onClick={() => navigate('/admissions/application')} className="border border-blue-600 text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition">
                            Admission Process
                        </button>
                    </div>
                </div>
                <div className="hidden md:block">
                    <LazyImage src="./img/layout/campus.jpg" placeholder="./img/layout/campus.jpg" alt="Campus" className="rounded-lg shadow-xl" />
                </div>
            </div>
